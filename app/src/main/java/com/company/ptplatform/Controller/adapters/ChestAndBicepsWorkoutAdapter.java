...
import com.company.ptplatform.Model.Beans.workout.Exercise__1;
...
public class ChestAndBicepsWorkoutAdapter extends RecyclerView.Adapter<ChestAndBicepsWorkoutAdapter.ViewHolder>  {
    ...
    private void setFragment(Fragment fragment,String title,String description, String img,String id) {
